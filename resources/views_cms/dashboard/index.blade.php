...
@section('content')
    <div class="flex bg-indigo-600 rounded-lg text-white shadow opacity-75 mb-10">
        <div class="w-1/3 border-r border-gray-100 p-5">
            <h3 class="uppercase font-medium text-indigo-300 text-sm">Registered Users</h3>
            <span class="text-3xl text-gray-100">{{ $stats['users'] }}</span>
        </div>
        <div class="w-1/3 border-r border-gray-100 p-5">
            <h3 class="uppercase font-medium text-indigo-300 text-sm">Orders today</h3>
            <span class="text-3xl text-gray-100">{{ $stats['orders-today'] }}</span>
        </div>
        <div class="w-1/3 border-r border-gray-100 p-5">
            <h3 class="uppercase font-medium text-indigo-300 text-sm">Pending Orders</h3>
