                ...
                <template slot="form" slot-scope="data">
                    ...
                    <div class="md:flex items-center mb-3">
                        ...
                        <input id="company_name" class="bg-gray-100" placeholder="Company Name"
                               value="{{ $address->company_name ?? old('company_name') ?: auth()->user()->customer->name }}"
                               name="company_name">
                    </div>

                    <div class="md:flex items-center mb-3">
                        <label for="address_line_2" class="md:w-2/6">Address Line 2 <span
                                class="text-red-600">*</span></label>
                        <input id="address_line_2" class="bg-gray-100" placeholder="Address Line 2"
                               name="address_line_2"
                               :value="data.selected_address.line_1 ? data.selected_address.line_1 : '{{ old('address_line_2') ?: $address->address_line_2 ?? null }}'">
                    </div>

                    <div class="md:flex items-center mb-3">
                        <label for="address_line_3" class="md:w-2/6">Address Line 3 <span
                                class="text-red-600">*</span></label>
                        <input id="address_line_3" class="bg-gray-100" placeholder="Address Line 3"
                               name="address_line_3"
                               :value="data.selected_address.town_or_city ? data.selected_address.town_or_city : '{{ old('address_line_3') ?: $address->address_line_3 ?? null }}'">
                    </div>
                    ...
                    <div class="md:flex items-center mb-3">
                        ...
                        <input id="address_line_4" class="bg-gray-100" placeholder="Address Line 4"
                               name="address_line_4"
                               :value="data.selected_address.locality ? data.selected_address.locality : '{{ old('address_line_4') ?: $address->address_line_4 ?? null }}'">
                    </div>
                    ...
                    <div class="md:flex items-center mb-3">
                        ...
                        <input id="address_line_5" class="bg-gray-100" placeholder="Address Line 5"
                               name="address_line_5"
                               :value="data.selected_address.county ? data.selected_address.county : '{{ old('address_line_5') ?: $address->address_line_5 ?? null }}'">
                    </div>
