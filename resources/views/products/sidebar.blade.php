<mobile-menu>
    <template slot="trigger">
        <div
             class="xl:hidden fixed left-0 bg-background_primary-color text-background_primary-text pt-3 pb-3 pr-3 pl-2 rounded-tr-full rounded-br-full hover:cursor-pointer hover:opacity-75 shadow z-50">
