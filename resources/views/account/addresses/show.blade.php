...
@section('content')
    ...
    {{--                </div>--}}
    {{--                <small--}}
    {{--                    class="form-text text-muted mb-4">{{ __('You will still need to enter company name & address line 2 manually') }}</small>--}}
    ...
    <form method="post"
        ...
        {{--                               name="default" {{ old('postcode') ? 'checked' : (isset($address) ? ($address->default == 1 ? 'checked' : '') : '') }}>--}}
