...
class HomeLinksControllerTest extends TestCase
{
    ...
    public function destroy_returns_an_ok_response()
    {
        ...
        $home_link = factory(\App\Models\HomeLink::class)->create();
    ...
    public function store_returns_an_ok_response()
    {
        ...
        $response = $this->actingAs($user, 'admin')->post(route('cms.home-links.store'), [
    ...
    public function update_positions_returns_an_ok_response()
    {
        ...
        $response = $this->actingAs($user, 'admin')->patch(route('cms.home-links.update'), [
            // TODO: send request data
        ]);
